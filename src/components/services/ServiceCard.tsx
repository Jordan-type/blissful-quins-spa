  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-end transition-opacity duration-500 ease-out group-hover:opacity-0">
        <div className="bg-[#6b5e52]/70 backdrop-blur-[2px] px-6 py-6">
      ...
      {/* Hover State */}
      <div className="absolute inset-0 flex flex-col items-center justify-center px-10 text-center bg-[#6b5e52]/65 backdrop-blur-[3px] opacity-0 transition-all duration-500 ease-out group-hover:opacity-100">
        ...
        <span
          className="px-8 py-3 rounded-full bg-[#e8ddd1] text-[#4a3f35] text-sm font-medium tracking-wide
          transition-all duration-300 hover:bg-[#f5efe8] hover:shadow-lg
